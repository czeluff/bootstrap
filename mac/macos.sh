...
read -p "Specify a computer name: " name
sudo scutil --set ComputerName $name 
sudo scutil --set HostName $name 
lhname=`echo $name | gsed "s/'//g;s/ /-/g;s/\(.*\)/\L\1/"`
...
cp mac/softe-jivebs.png ~/Pictures/wall.png
...
# Fade instead of swipe for Mission Control
...
# Safari & WebKit                                                             #
###############################################################################
## TODO THESE SEEM LARGELY BROKEN IN BIG SUR
...
# Check for software updates monthly, not once per week
